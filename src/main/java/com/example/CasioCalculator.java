...
public class CasioCalculator extends JFrame {
    ...
    private void initializeUI() {
        setTitle("CASIO fx-991CN X - Java Edition");
    ...
    private ButtonType determineButtonType(String text) {
        if (text.matches("[0-9.]")) return ButtonType.NUMBER;
        if (text.equals("=")) return ButtonType.EQUALS;
        if ("+-×÷%".contains(text)) return ButtonType.OPERATOR;
        if (text.equals("AC") || text.equals("DEL")) return ButtonType.SPECIAL;
    ...
    private JPanel createMatrixInput(String title, JTextField[][] fields) {
        ...
        panel.setBorder(new TitledBorder(new LineBorder(Color.GRAY, 2), title, 
    ...
    private JPanel createEquationPanel() {
        ...
        inputPanel.setBorder(new TitledBorder(new LineBorder(Color.GRAY, 2), "输入方程",
            TitledBorder.LEFT, TitledBorder.TOP,
            new Font("Arial", Font.BOLD, 14), Color.WHITE));
        inputPanel.setBorder(BorderFactory.createCompoundBorder(
            inputPanel.getBorder(), new EmptyBorder(15, 15, 15, 15)));
    ...
    private JPanel createGraphPanel() {
        ...
        JPanel inputPanel = new JPanel(new BorderLayout(8, 8));
        inputPanel.setBackground(new Color(55, 55, 55));
        inputPanel.setBorder(new TitledBorder(new LineBorder(Color.GRAY, 2), "函数表达式 y = f(x)",
            TitledBorder.LEFT, TitledBorder.TOP,
            new Font("Arial", Font.BOLD, 14), Color.WHITE));
        inputPanel.setBorder(BorderFactory.createCompoundBorder(
            inputPanel.getBorder(), new EmptyBorder(12, 12, 12, 12)));
        ...
        plotBtn.setFont(new Font("Arial", Font.BOLD, 16));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            new CasioCalculator().setVisible(true);
        });
    }
